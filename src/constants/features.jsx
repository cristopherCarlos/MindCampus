...
export const PLATFORM_FEATURES = [
  {
    ...
    desc: "Nombra lo que sientes a través de nuestra rueda interactiva.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6 text-neutral-700">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 0 1-6.364 0M9 10.5h.01M15 10.5h.01" />
      </svg>
    )
  },
  {
    id: "2",
    title: "Conversemos",
    desc: "Reflexiona con preguntas terapéuticas guiadas.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6 text-neutral-700">
  ...
  },
  {
    id: "3",
    title: "Actividades",
    desc: "Ejercicios inmediatos adaptados a tu estado de ánimo.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6 text-neutral-700">
  ...
  },
  {
    id: "4",
    title: "Mi registro",
    desc: "Sigue tu tendencia emocional semana a semana.",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6 text-neutral-700">
